 ...
 * 2018-08-12T17:44:36.183+08:00
 * Generated source version: 3.2.5
 *
 */
@WebServiceClient(name = "WeatherWebService",
                  wsdlLocation = "classpath:wsdl/WeatherWebService.asmx.xml",
...
public class WeatherWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("classpath:wsdl/WeatherWebService.asmx.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "classpath:wsdl/WeatherWebService.asmx.xml");
        }
        WSDL_LOCATION = url;
    }
